...
baidu.lang.Class.prototype.fire = baidu.lang.Class.prototype.dispatchEvent = function(f, a) {
    baidu.lang.isString(f) && (f = new baidu.lang.Event(f));
...
baidu.lang.Class.prototype.on = baidu.lang.Class.prototype.addEventListener = function(f, d, c) {
...
(function() {
    ...
    baidu.dom.drag = function(p, o) {
        ...
        i = baidu.object.extend({
            autoStop: true,
            capture: true,
            interval: 16
        }, o);
        a = g = parseInt(baidu.dom.getStyle(j, "left")) || 0;
        l = m = parseInt(baidu.dom.getStyle(j, "top")) || 0;
        setTimeout(function() {
            var q = baidu.page.getMousePosition();
            f = i.mouseEvent ? (baidu.page.getScrollLeft() + i.mouseEvent.clientX) : q.x;
            d = i.mouseEvent ? (baidu.page.getScrollTop() + i.mouseEvent.clientY) : q.y;
            clearInterval(c);
            c = setInterval(b, i.interval)
        }, 1);
        i.autoStop && baidu.event.on(document, "mouseup", k);
        baidu.event.on(document, "selectstart", h);
        ...
        baidu.lang.isFunction(i.ondragstart) && i.ondragstart(j, i);
        return {
            stop: k,
            dispose: k,
            update: function(q) {
                baidu.object.extend(i, q)
            }
        }
    };
    ...
    function k() {
        ...
        baidu.event.un(document, "selectstart", h);
        i.autoStop && baidu.event.un(document, "mouseup", k);
        baidu.lang.isFunction(i.ondragend) && i.ondragend(j, i, {
            left: a,
            top: l
        })
    }
    ...
    function b(s) {
        var p = i.range || [],
            o = baidu.page.getMousePosition(),
            q = g + o.x - f,
            r = m + o.y - d;
        if (baidu.lang.isObject(p) && p.length == 4) {
            q = Math.max(p[3], q);
        ...
        a = q;
        l = r;
        baidu.lang.isFunction(i.ondrag) && i.ondrag(j, i, {
            left: a,
            top: l
        })
    }
...
baidu.dom.setStyle = function(c, b, d) {
    ...
    a = f._styleFixer[b];
    (a && a.set) ? a.set(c, d, b) : (c.style[a || b] = d);
    return c
};
...
baidu.dom.getCurrentStyle = function(b, a) {
    b = baidu.dom.g(b);
    return b.style[a] || (b.currentStyle ? b.currentStyle[a] : "") || baidu.dom.getComputedStyle(b, a)
};
...
baidu.dom.resizable = function(d, h) {
    var A, n, j = {}, c, a = {}, s, y, v, b, f, l, p, t = false,
        k = false,
        w = {
            direction: ["e", "s", "se"],
            minWidth: 16,
    ...
    n = baidu.extend(w, h);
    baidu.each(["minHeight", "minWidth", "maxHeight", "maxWidth"], function(B) {
    ...
    function g() {
        f && u();
        baidu.object.each(j, function(B) {
            baidu.un(B, "mousedown", i);
            baidu.dom.remove(B)
        });
        t = true
    }
...
baidu.dom._styleFixer.width = baidu.dom._styleFixer.height = {
    get: function(b, a, c) {
        var a = a.replace(/^[a-z]/, function(f) {
...
baidu.form.serialize = function(c, f) {
    var b = c.elements,
        f = f || function(r, i) {
            return r
        }, j = [],
...
(function() {
    var a = window[baidu.guid].global;
    baidu.global.set = function(f, g, d) {
...
baidu.lang.createClass = function(b, k) {
    k = k || {};
    ...
    var j = function() {
        ...
        b.apply(n, arguments);
        for (var l = 0, m = j["\x06r"]; m && l < m.length; l++) {
            m[l].apply(n, arguments)
        }
    };
    j.options = k.options || {};
    var a = function() {}, g = b.prototype;
...
baidu.page.load = function(c, k, f) {
    ...
    var i = baidu.page.load,
        a = i._cache = i._cache || {}, h = i._loadingCache = i._loadingCache || {}, g = k.parallel;
...
baidu.swf.createHTML = function(t) {
    ...
    var l = baidu.swf.version,
        h = t.ver || "6.0.0",
        g, d, f, c, j, s, a = {}, p = baidu.string.encodeHTML;
    for (c in t) {
        a[c] = t[c]
    }
    t = a;
